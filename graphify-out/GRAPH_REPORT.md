...
## Corpus Check
- 133 files · ~73,696 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 922 nodes · 1463 edges · 98 communities (91 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b5f98259`
...
3. `../../../core/providers/connection_status_provider.dart` - 26 edges
4. `package:riverpod_annotation/riverpod_annotation.dart` - 26 edges
5. `package:dio/dio.dart` - 16 edges
6. `../../auth/presentation/auth_controller.dart` - 12 edges
7. `dart:async` - 11 edges
8. `../../../../core/utils/snackbar_utils.dart` - 11 edges
9. `../../../core/routes/app_routes.dart` - 10 edges
10. `package:font_awesome_flutter/font_awesome_flutter.dart` - 9 edges

## Surprising Connections (you probably didn't know these)
- `../../../core/providers/connection_status_provider.dart` --defines--> `ConnectionStatus`  [EXTRACTED]
  reward/presentation/reward_screen.dart → core/providers/connection_status_provider.dart
...
Cohesion: 0.09
Nodes (53): AlertDialog, Align, build, _buildGreetingCard, _buildInfoBoardCard, _buildInfoBoardLoading, _buildInfoBoardPlaceholder, _buildLeaderboardCard (+45 more)
...
Cohesion: 0.15
Nodes (35): Align, _animatedTabs, build, _buildLeaderboard, _buildMissionLoading, _buildMissionsList, _buildOfflinePlaceholder, _buildPodium (+27 more)
...
Cohesion: 0.05
Nodes (35): build, Color, Container, _createShimmerShader, dispose, _GradientText, initState, LayoutBuilder (+27 more)

### Community 6 - "Community 6"
Cohesion: 0.1
Nodes (19): AppConnectivityWrapper, AppRoutes, MaterialPageRoute, _materialRoute, PageRouteBuilder, _slideRoute, SlideTransition, ../enums/otp_type.dart (+11 more)

### Community 7 - "Community 7"
Cohesion: 0.3
Nodes (10): auth_interceptor.dart, AlertDialog, build, DioClientService, DioErrorHandler, parse, package:flutter_dotenv/flutter_dotenv.dart, package:shared_preferences/shared_preferences.dart (+2 more)
...
Cohesion: 0.24
Nodes (20): build, _buildHistoryCard, _buildHistoryLoading, _buildOfflinePlaceholder, Center, Container, dispose, initState (+12 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (31): _decryptResponse, EncryptionInterceptor, _generateRandomString, onError, onRequest, onResponse, Exception, KeyManager (+23 more)

### Community 11 - "Community 11"
Cohesion: 0.08
Nodes (47): ../../auth/presentation/auth_controller.dart, CommentActionController, CommentListController, build, _buildCommentCard, _buildCommentLoading, _buildInputSection, _buildOfflineCard (+39 more)
...
Cohesion: 0.3
Nodes (13): build, _buildFaqList, _buildFaqTile, _buildLoadingPlaceholder, _buildOfflineFaqList, Center, Column, Container (+5 more)
...
Cohesion: 0.15
Nodes (9): AppTheme, ThemeData, AppSnackBars, show, build, CustomButton, SizedBox, package:flutter/material.dart (+1 more)
...
Cohesion: 0.17
Nodes (11): build, ClampingScrollPhysics, dispose, initState, LoginScreen, _LoginScreenState, Scaffold, SingleChildScrollView (+3 more)
...
Cohesion: 0.2
Nodes (9): build, dispose, initState, RegisterScreen, _RegisterScreenState, Scaffold, SizedBox, Text (+1 more)
...
Cohesion: 0.29
Nodes (6): build, MissionController, MissionTabState, setLeaderboard, setMission, ../data/mission_repository.dart

### Community 27 - "Community 27"
Cohesion: 0.22
Nodes (8): build, ForgotPasswordScreen, _ForgotPasswordScreenState, Scaffold, SizedBox, Text, ../../../core/enums/otp_type.dart, ../../../core/theme/app_theme.dart
...
Cohesion: 0.53
Nodes (4): AppConnectivityWrapper, build, Stack, ../providers/connection_status_provider.dart
...
Cohesion: 0.4
Nodes (4): main, ProviderScope, package:flutter_test/flutter_test.dart, package:polislot_mobile_catz/main.dart

## Knowledge Gaps
- **488 isolated node(s):** `ListView`, `MainActivity`, `Intercept NOTIFY_DEBUGGER_ABOUT_RX_PAGES and touch the pages.`, `-registerWithRegistry`, `PoliSlotApp` (+483 more)
...
- **Why does `package:flutter/material.dart` connect `Community 17` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 25`, `Community 27`, `Community 29`, `Community 34`, `Community 62`, `Community 63`, `Community 98`?**
  _High betweenness centrality (0.247) - this node is a cross-community bridge._
- **Why does `package:flutter_riverpod/flutter_riverpod.dart` connect `Community 9` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 98`, `Community 5`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 25`, `Community 27`, `Community 62`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `package:riverpod_annotation/riverpod_annotation.dart` connect `Community 18` to `Community 1`, `Community 3`, `Community 7`, `Community 42`, `Community 43`, `Community 44`, `Community 13`, `Community 45`, `Community 46`, `Community 47`, `Community 11`, `Community 48`, `Community 23`, `Community 26`, `Community 59`, `Community 28`, `Community 61`, `Community 30`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **What connects `ListView`, `MainActivity`, `Intercept NOTIFY_DEBUGGER_ABOUT_RX_PAGES and touch the pages.` to the rest of the system?**
