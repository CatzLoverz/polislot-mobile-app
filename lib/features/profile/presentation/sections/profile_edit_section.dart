...
class _ProfileEditSectionState extends ConsumerState<ProfileEditSection> {
  ...
  void _validateMatch() {
    setState(() {
      _isMatchConfirm = _newPassController.text.isNotEmpty && 
  ...
  Widget _inputField(String label, TextEditingController controller, {bool obscure = false, bool enabled = true, Widget? suffixIcon}) {
    return Container(
